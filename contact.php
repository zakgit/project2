<?php
	...
	*/
	...
	$contact_email = 'zakgit@gmail.com'; //Example : Youremail.com
	...
	*/
	...
	$message.= 'Type: '.$from_type.PHP_EOL.PHP_EOL;
	...
	if(!empty($from_name) && !empty($from_email) && !empty($from_phone) && !empty($from_type) && !empty($message))
	{
